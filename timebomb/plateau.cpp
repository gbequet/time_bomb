...
void Plateau::show_rules(){
    ui->overlay_fin->show();
    ui->label_fin->setStyleSheet("background-color:#53230a; font-size:15pt;");
    ui->label_fin->setText("Le document présentant les règles du jeu n'a pas pu être affiché au sein du logiciel en raison de difficultés d'intégration."
                           " Les règles sont toutefois disponibles sous la forme d'un document PDF, dans le dossier principal du jeu."
                           " Pour le document français, consulter `regles-fr.pdf`.");
